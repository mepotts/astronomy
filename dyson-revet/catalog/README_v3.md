...
pre-visual recovery at |b| > 30° runs **26.1% to 44.4%** depending
on which SED family the object belongs to, measured on 100800 injections
...
1. **The γ ≈ 0.05 blindness is family-dependent.** For optically-thin
   dust the screen recovers **11.3%** at γ = 0.05 where a single
   blackbody gives **1.8%** — it is *six times less blind* there.
...
2. **The 1000 K temperature wall is not a property of the screen.**
   ...
   **30–37%**, because T_cool = T_warm/3 is back inside the
