...
**2026-09-02 reproducibility amendment:** that original rolling CSV had no frozen
identity or report-publication timestamps. New runs pin an immutable full-scan
snapshot and apply a discovery-date-bounded conservative veto; later current TNS
matches are annotation-only. This is not an exact reconstruction of historical
registry membership. See `OPERATING-GUIDE.md` §2, Layer 6.
